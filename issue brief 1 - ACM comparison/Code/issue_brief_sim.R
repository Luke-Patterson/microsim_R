  ...
  ri <- policy_simulation(saveCSV=TRUE,
                            ...
                            dependent_allow = 10,
                            sens_var='resp_len',
                            own_uptake= .0803, matdis_uptake=.268, bond_uptake=.0104, illparent_uptake=.0009,
  ...
  policy_simulation(saveCSV=TRUE,
                    ...
                    dependent_allow = 10,
                    sens_var='resp_len',
                    own_uptake=.035, matdis_uptake=.01, bond_uptake=.01, illparent_uptake=.001,
  ...
  policy_simulation(saveCSV=TRUE,
                            ...
                            dependent_allow = 10,
                            sens_var='resp_len',
                            own_uptake=.07, matdis_uptake=.02, bond_uptake=.02, illparent_uptake=.01,
                            illspouse_uptake=.01, illchild_uptake=.005,
